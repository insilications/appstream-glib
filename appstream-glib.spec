...
Source0  : https://people.freedesktop.org/~hughsient/appstream-glib/releases/appstream-glib-0.7.14.tar.xz
...
%prep
%setup -q -n appstream-glib-0.7.14
...
export LANG=C
export SOURCE_DATE_EPOCH=1539806704
