...
%prep
%setup -q -n appstream-glib-0.7.17
cd %{_builddir}/appstream-glib-0.7.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585589030
...
cp %{_builddir}/appstream-glib-0.7.17/COPYING %{buildroot}/usr/share/package-licenses/appstream-glib/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/appstream-glib-0.7.17/data/tests/rpmbuild-font/COPYING %{buildroot}/usr/share/package-licenses/appstream-glib/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
