...
Source0  : https://people.freedesktop.org/~hughsient/appstream-glib/releases/appstream-glib-0.7.12.tar.xz
...
Requires: appstream-glib-license
Requires: appstream-glib-locales
Requires: appstream-glib-man
...
%prep
%setup -q -n appstream-glib-0.7.12
...
export LANG=C
export SOURCE_DATE_EPOCH=1534947972
...
%install
mkdir -p %{buildroot}/usr/share/doc/appstream-glib
cp COPYING %{buildroot}/usr/share/doc/appstream-glib/COPYING
cp data/tests/rpmbuild-font/COPYING %{buildroot}/usr/share/doc/appstream-glib/data_tests_rpmbuild-font_COPYING
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/appstream-glib/COPYING
/usr/share/doc/appstream-glib/data_tests_rpmbuild-font_COPYING
